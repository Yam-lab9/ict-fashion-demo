...
const INIT_COUPONS = [
  { id:1, code:"ICT10", type:"percent", value:10, minOrder:0, active:true, uses:24, maxUses:100 },
...
const INIT_ORDERS = [
  { id:"ICT-2401", customer:"Ahmed Hassan", phone:"01712-345678", address:"House 12, Mirpur, Dhaka", city:"Dhaka",
  ...
  { id:"ICT-2400", customer:"Fatima Khatun", phone:"01813-456789", address:"Nasirabad, Chittagong", city:"Chittagong",
  ...
  { id:"ICT-2399", customer:"Mohammed Khan", phone:"01611-234567", address:"Shahjalal, Sylhet", city:"Sylhet",
    items:[{name:"Classic Cotton Punjabi",size:"XL",color:"White",qty:2,price:3600}],
    subtotal:3600, discount:360, shipping:0, total:3240, status:"Shipped", date:"15 May 2026", coupon:"ICT10", note:"" },
  { id:"ICT-2398", customer:"Rahima Begum", phone:"01914-567890", address:"Bogra Road, Rajshahi", city:"Rajshahi",
...
.sinput:focus { border-color: var(--blk); width: 260px; box-shadow: 0 0 0 3px rgba(191,155,48,.15); }
...
.btn-gold:hover { background: var(--gold2); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(191,155,48,.4); }
...
.wcard:hover { border-color: var(--gold); box-shadow: 0 8px 32px rgba(191,155,48,.12); transform: translateY(-4px); }
...
.fsoc:hover { border-color: var(--gold); color: var(--gold); background: rgba(191,155,48,.08); }
...
.adm-ni.on { color: #fff; background: rgba(191,155,48,.1); border-left-color: var(--gold); }
...
function Footer({ navigate }) {
  return (
    <footer className="footer">
      ...
      <div className="ctr">
        <div className="fbot">
          <div className="fcopy">© 2026 Infinite Code Tech · Demo Showcase</div>
          <div className="fdev">Concept website by <em>Infinite Code Tech</em> · For demonstration purposes</div>
        </div>
      </div>
    </footer>
  );
...
function HomePage({ navigate, products, banners, addToCart, buyNow }) {
  ...
  const faqs = [
    ...
    { q: "Can I customize my order size?", a: "Select 'Customize' to preview a sizing inquiry. This demo does not send WhatsApp messages." },
  ];
    ...
    <>
      ...
      <div className="stats-band">
        <div className="ctr">
          <div className="stats-grid">
            {[["12000+", "Demo Customers"], ["500+", "Sample Range"], ["50+", "Demo Cities"], ["100%", "Demo Collection"]].map(([n, l], i) => (
        ...
        <div className="ctr">
          <AnimSection>
            <div style={{ textAlign: "center", marginBottom: 42 }}>
              ...
              <div className="sec-tit">Why Choose This Collection</div>
            </div>
          </AnimSection>
          <div className="wgrid">
      ...
      <div className="sec bg">
        <div className="ctr">
          <AnimSection>
            <div style={{ textAlign: "center", marginBottom: 42 }}>
              <div className="sec-eye" style={{ justifyContent: "center" }}>Sample Customer Stories</div>
              <div className="sec-tit">Sample Customer Reviews</div>
            </div>
          </AnimSection>
          <div className="tgrid">
          ...
          <AnimSection dir="left">
            <div>
              ...
              <div className="size-opts">
                ...
                <button className="sbtn cust" onClick={() => previewInquiry(`Custom sizing: ${p.name}`)}>Customize</button>
              </div>
  ...
  if (placed) return (
    <div className="suc-ov" onClick={() => navigate("home")}>
      <div className="suc-box" onClick={e => e.stopPropagation()}>
        ...
        <div className="suc-tit">Demo Order Confirmed!</div>
        <div className="suc-txt">Thank you, {form.name}. Your demo order is complete. No purchase, payment or delivery will take place.</div>
  ...
  return (
    <div className="adm-lay">
      <div className="adm-side">
        <div className="adm-slogo">ICT<em>.</em><small>Admin Panel</small></div>
        {nav.map(n=>(
          <div key={n.id}>
      ...
      <div className="adm-con">
        <div className="adm-top">
          ...
          <div className="adm-usr"><div className="adm-av">A</div><span>ICT Demo Admin</span></div>
        </div>
            ...
            viewOrder ? (
              <div className="adm-card">
                <div className="adm-ch">
                  ...
                  <button className="abtn sm" onClick={()=>previewInquiry("Customer message")}>WhatsApp</button>
                </div>
                <div className="adm-cb">
